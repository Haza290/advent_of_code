...
get_lowest_step_cross_1_test() ->
    ?assertEqual(610, day3:get_lowest_step_cross(["R75","D30","R83","U83","L12","D49","R71","U7","L72"],["U62","R66","U55","R34","D71","R55","D58","R83"])).

get_lowest_step_cross_2_test() ->
    ?assertEqual(410, day3:get_lowest_step_cross(["R98","U47","R26","D63","R33","U87","L62","D20","R33","U53","R51"],["U98","R91","D20","R16","D67","R40","U7","R15","U6","R7"])).
...
get_points_from_move_right_test() ->
    ?assertEqual([{6,5,2},{5,5,1},{4,5,0}], day3:get_points_from_move("R3", {3,5},0)).
